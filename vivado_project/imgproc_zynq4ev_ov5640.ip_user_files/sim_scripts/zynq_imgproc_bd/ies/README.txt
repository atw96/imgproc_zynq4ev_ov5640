...
#
# Generated by export_simulation on Sat Apr 18 13:39:24 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './zynq_imgproc_bd.sh' script.

./zynq_imgproc_bd.sh -reset_run
...
./zynq_imgproc_bd.sh -noclean_files

For more information on the script, please type './zynq_imgproc_bd.sh -help'.
