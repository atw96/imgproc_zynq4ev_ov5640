...
-- Date        : Sat Apr 18 11:10:03 2026
-- Host        : DESKTOP-TEFC33U running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top zynq_imgproc_bd_clk_wiz_0_0 -prefix
--               zynq_imgproc_bd_clk_wiz_0_0_ zynq_imgproc_bd_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : zynq_imgproc_bd_clk_wiz_0_0
...
entity zynq_imgproc_bd_clk_wiz_0_0_zynq_imgproc_bd_clk_wiz_0_0_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    locked : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end zynq_imgproc_bd_clk_wiz_0_0_zynq_imgproc_bd_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of zynq_imgproc_bd_clk_wiz_0_0_zynq_imgproc_bd_clk_wiz_0_0_clk_wiz is
  signal clk_out1_zynq_imgproc_bd_clk_wiz_0_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_zynq_imgproc_bd_clk_wiz_0_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT0 => clk_out1_zynq_imgproc_bd_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zynq_imgproc_bd_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    locked : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  ...
  attribute NotValidForBitStream of zynq_imgproc_bd_clk_wiz_0_0 : entity is true;
end zynq_imgproc_bd_clk_wiz_0_0;

architecture STRUCTURE of zynq_imgproc_bd_clk_wiz_0_0 is
begin
inst: entity work.zynq_imgproc_bd_clk_wiz_0_0_zynq_imgproc_bd_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked
