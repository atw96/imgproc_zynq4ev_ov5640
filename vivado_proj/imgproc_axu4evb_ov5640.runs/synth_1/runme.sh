...
HD_PWD='D:/Project/Vivado/zynq4ev/imgproc_mpsoc/vivado_proj/imgproc_axu4evb_ov5640.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imgproc_top_ov5640.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imgproc_top_ov5640.tcl
