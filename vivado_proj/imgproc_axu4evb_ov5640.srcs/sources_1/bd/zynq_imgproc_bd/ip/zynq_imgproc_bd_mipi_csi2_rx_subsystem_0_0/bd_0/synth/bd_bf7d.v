...
//--------------------------------------------------------------------------------
//Command: generate_target bd_bf7d.bd
//Design : bd_bf7d
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_bf7d,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_bf7d,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "zynq_imgproc_bd_mipi_csi2_rx_subsystem_0_0.hwdef" *) 
module bd_bf7d
   (clkoutphy_out,
    csirxss_csi_irq,
