...
-- Date        : Sat Apr 18 11:10:13 2026
-- Host        : DESKTOP-TEFC33U running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top zynq_imgproc_bd_axi_sc_hp1_0 -prefix
--               zynq_imgproc_bd_axi_sc_hp1_0_ zynq_imgproc_bd_axi_sc_hp1_0_stub.vhdl
-- Design      : zynq_imgproc_bd_axi_sc_hp1_0
...
entity zynq_imgproc_bd_axi_sc_hp1_0 is
  Port ( 
    aclk : in STD_LOGIC;
...
end zynq_imgproc_bd_axi_sc_hp1_0;

architecture stub of zynq_imgproc_bd_axi_sc_hp1_0 is
...
attribute X_CORE_INFO of stub : architecture is "bd_0cbc,Vivado 2020.1";
begin
end;
