...
-- Date        : Wed May 27 21:27:14 2026
-- Host        : DESKTOP-TEFC33U running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top zynq_imgproc_bd_axi_sc_cfg_0 -prefix
--               zynq_imgproc_bd_axi_sc_cfg_0_ zynq_imgproc_bd_axi_sc_cfg_0_stub.vhdl
-- Design      : zynq_imgproc_bd_axi_sc_cfg_0
...
entity zynq_imgproc_bd_axi_sc_cfg_0 is
  Port ( 
    aclk : in STD_LOGIC;
...
end zynq_imgproc_bd_axi_sc_cfg_0;

architecture stub of zynq_imgproc_bd_axi_sc_cfg_0 is
...
attribute X_CORE_INFO of stub : architecture is "bd_95fd,Vivado 2020.1";
begin
end;
