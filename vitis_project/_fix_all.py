...
# Remove harmful factory patch from deploy sync
p = Path(r"d:/Project/Vivado/zynq4ev/imgproc_mpsoc/vitis_project/deploy.bat")
s = p.read_text(encoding="utf-8")
old = """echo [sync] patch psu_init DDR from doc/factory_vivado (keep GEM3)
powershell -NoProfile -ExecutionPolicy Bypass -File \"%SCRIPT_DIR%patch_psu_ddr_from_factory.ps1\"
if errorlevel 1 exit /b 1
"""
new = """echo [sync] verify psu_init from Vivado (do NOT factory-patch)
...
if old in s:
    ...
    print("deploy.bat sync fixed")

# burn_stable.bat - ONE xsct session, official order
stable = r"""@echo off
...
exit /b 0
"""
Path(r"d:/Project/Vivado/zynq4ev/imgproc_mpsoc/vitis_project/burn_stable.bat").write_text(stable, encoding="utf-8")
print("burn_stable.bat written")
