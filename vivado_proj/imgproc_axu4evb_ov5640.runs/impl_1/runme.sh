...
HD_PWD='D:/Project/Vivado/zynq4ev/imgproc_mpsoc/vivado_proj/imgproc_axu4evb_ov5640.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log imgproc_top_ov5640.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source imgproc_top_ov5640.tcl -notrace
