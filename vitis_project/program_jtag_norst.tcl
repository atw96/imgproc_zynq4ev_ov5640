# psu_init without rst -system (some boards hang after full system reset)
...
# program_jtag_norst.tcl — 无 rst -system，冷启动更稳定
set ::HW_SERVER_URL "TCP:127.0.0.1:10245"

log_step {=== JTAG norst: psu_init + fpga + elf ===}
catch {disconnect}
after 2000
...
if {[catch {dow -clear $elf} err]} {
    log_step "WARN: dow retry after stop: $err"
    catch {stop -timeout 20000}
    catch {rst -processor}
    after 2000
